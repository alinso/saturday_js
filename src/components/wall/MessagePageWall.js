...
import MessageBoxWall from "./MessageBoxWall";
import SinglePhotoSelector from "../common/SinglePhotoSelector";

const axios = require('axios');


class MessagePageWall extends React.Component {
    constructor(props) {
        super(props);
        Security.protect();
        ...
        if(this.props.match.params.id===5821)
        {
            return;
        }
        this.state = {
    ...
    urlify(text) {
        ...
        return text.replace(urlRegex, function (url) {
            return '<a href="' + url + '"><strong>[---LINK---]</strong></a>';
        })
        // or alternatively
...
export default MessagePageWall;