...
class EventAlbum extends React.Component {
    ...
    fillFields() {
        ...
        axios.get(Globals.serviceUrl + 'eventPhoto/album/' + this.props.match.params.id, security.authHeader())
    ...
    handleUpload = () => {
        ...
        axios.post(Globals.serviceUrl + "eventPhoto/upload/" + this.props.match.params.id, data, security.authHeader(), {
    ...
    render() {
        ...
        return (
            <div className="container">
                ...
                <h5><a href={"/eventDetail/"+this.props.match.params.id}>Aktivite {this.props.match.params.id}</a> </h5>
                </div>
                <div className={"half-left"}>
                <h5><a href={"/messageevent/"+this.props.match.params.id}>Grup Mesajları</a> </h5>
                </div>
