        ...
        return (
            <div className="row outer">
                <div className={"col-md-6 text-align-left container"}>
                    <h4>İletişim</h4>
                    <hr/>
                    Her türlü geri dönüşün için instagramdan(@activityfriend),  mail@activityfriend.net(bunu tavsiye etmiyoruz, mail atmak çok yavaş bir iletişim şekli instagram daha iyidir)
